...
<?php if ($page==1)://Bravo Categories ?>
    <h3> Select a Program</h3>
    <?php foreach($categories as $cat): ?>
        <div class="bravo_cat">
            <h4><?php echo $cat[0];?></h4>
            <?php foreach($cat[1] as $group): ?>
                <a href="<?php echo site_url("/rental_applications/bravo/page/2/?group={$group->category_id}");?>">
                  <?php echo $group->category_name; ?>
                </a><br/>
            <?php endforeach;?>
        </div>
...
<?php if ($page==2)://Bravo Instruments?>
...
<?php if ($page==3)://Instrument Details?>
...
<?php if ($page==4)://M & R?>
    ...
    <p> M&R will be included with the rental of any Bravo/Bravissimo Step-up Instrument.</p>

    <p>Price: $<?php echo $m_r_price;?></p>
    <?php endif; ?>


<?php if ($page==-1): //accessories are remove (page -1) -- change to 5 and reindex the pages that follow?>
    <h3>Accessories</h3>
    //TODO School Filter
...
<?php if ($page==10)://Final Page --//Success or Failure?>
//Yay!!! finished
    <?php endif;?>
